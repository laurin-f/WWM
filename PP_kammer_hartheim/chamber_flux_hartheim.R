...
flux_13 <- chamber_arduino(datelim=ymd_hm("23.03.21 08:00","23.03.21 12:00"),
                           ...
                           t_min = 2,
                           t_max=10)
flux_13 <- chamber_arduino(datelim=ymd_hm("23.03.28 08:00","23.03.28 09:30"),
                           gga_data = T,
                           t_init=0,
                           plot="timeline",
                           t_offset = 50,
                           t_min = 2,
                           t_max=10)
flux_14 <- chamber_arduino(datelim=ymd_hm("23.04.07 11:15","23.04.07 13:30"),
                           gga_data = T,
                           t_init=0,
                           plot="timeline",
                           t_offset = 30,
                           t_min = 2,
                           t_max=10)
flux_15 <- chamber_arduino(datelim=ymd_hm("23.04.18 12:00","23.04.18 14:00"),
                           gga_data = T,
                           t_init=0,
                           plot="timeline",
                           t_offset = -100,
                           t_min = 2,
                           t_max=10)
flux_16 <- chamber_arduino(datelim=ymd_hm("23.04.28 08:00","23.04.28 09:00"),
                           gga_data = T,
                           t_init=0,
                           plot="timeline",
                           t_offset = -220,
...
t_offset_df <- data.frame(date = 
                            ymd_hm("2022-09-27 10:00","22.10.18 12:00","22.10.18 12:30","22.10.24 10:00","22.11.03 11:30","22.11.03 13:30","22.11.09 08:30","22.11.22 10:10","22.12.09 10:00","23.02.16 14:00","23.02.22 09:00","23.03.13 11:00","23.03.21 10:00","23.03.28 09:30","23.04.07 12:15","23.04.18 14:00","23.04.28 09:00"),
                          offset = c(-80,-300,120,60,-50,-20,-90,-200,-390,-1250,-1300,270,200,50,30,-100,-220))
