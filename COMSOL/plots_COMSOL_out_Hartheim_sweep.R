...
#anstatt glm geht es viel schneller jeweils den mittelwert von 3 
    ################
    #flux
    dC_dz_mol_3_10 <- rowMeans(cbind(F_df$CO2_ref_1 - F_df$CO2_ref_2,F_df$CO2_ref_2 - F_df$CO2_ref_3)/-3.5)
...
#mol/m^3/cm
    ...
    F_df$Fz_3_10 <- F_df$DS_1   * dC_dz_mol_3_10 * 100 * 10^6#m2/s * mol/m3/m = mumol/s/m2
...
F_df$Fz_roll_3_10 <- zoo::rollapply(F_df$Fz_3_10,width=w,mean,na.rm=F,fill=NA)
